package com.spring.cloud.bff.graphql.service;



import com.spring.cloud.bff.graphql.model.Book;
import com.spring.cloud.bff.graphql.mongoservice.base.BaseDocService;
import com.spring.cloud.bff.graphql.service.datafetcher.AllBooksDataFetcher;
import com.spring.cloud.bff.graphql.service.datafetcher.BookDataFetcher;
...
public class GraphQLService {
    ...
    @Autowired
    private BaseDocService<Book> bookBaseDocService;
    ...
    private void loadDataIntoHSQL() {
        ...
        Stream.of(
            ...
            bookBaseDocService.save(book, "test");
        });
    }
